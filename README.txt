...
If you've got any feedback, please reach out to me with any questions/comments/advice/suggestions at amangrover1000@gmail.com! I had a lot of fun creating this, and I'd love to hear what more people think about it. 

I also want to clarify that this project is not intended to be politically partisan in any way. 
...
Those are just ones that I found fascinating and will likely explore myself. That said, there are countless more interesting possibilities!

To clarify something a few people have asked me: Polarity vs. Subjectivity 
...
To create one, go to https://developers.facebook.com/ , click "My Apps", and then click "Create New App". Once you've created an account (or if you already had one), find your app ID and access token. Paste these into the respective fields.
...
Now, you're ready to execute the main file. Once you do, you will be prompted to name your file (this is a .CVS file where all status data such as article text content, number of likes, number of comments, subjectivity, etc will be included). Follow standard file name procedures (ex: no special characters or certain symbols). 
...
2. There may be small, occasional gaps in the dates of the posts collected (as in, some dates will be missing). This is a problem with the Facebook Graph API that the company has acknowledged (https://developers.facebook.com/bugs/1838195226492053/).
